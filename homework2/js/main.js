...
let e = null || 0 || 35; //35 1е значение которое является true
console.log(e);

let g = null && 0 && 35;  //null - 1ый аргумент который false, остальные игнорируются
console.log(g);

12 + 14 + '12' //2612, т.к есть строковой аргумент. при бинарном плюсе первый аргумент(результат сложения 12+14) станет строчным
